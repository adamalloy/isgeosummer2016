...
"""
def convercsv():
	csvfile = open('~/CeleyaData.csv', 'r')
	reader = csv.DictReader(csvfile, fieldnames =  ("Team Number", "Station Number", "Date and Time of Data", "Coordinates of Site", "Prepended text", "Station references", "Fault Name", "Data Type", "Strike of Fault", "Angle Between Surface and Slip or Dip", "Throw of Fault", "Slip of Fault", "Hand Written Notes", "Image 1 Link", "Image 1 Subject", "Image Description and Key Words", "Image 2 Link", "Image 2 Subject", "Image 2 Descrition and Key Words", "Image 3 Link","Image 3 Subject", "Image 3 Description and Key Words", "Track Map Image", "Track Map URL", "More Comments"))
...
def route_home():
    ...
    """
    return send_file("""whatever/the/path""")

@app.route('/subsidence/Celeaya')
def route_celeya():
    """
    routing the json for Celeya
    """

    json = {}
    Celeya = SubsidencePoint.query.all()
    for data in Celeya:
        json[data.id] = data.serialize()
    return jsonify(Celeya)
